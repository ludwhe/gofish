...
redirect:
	...
	default:
		printf("Unexpected error result %d\n", rc);
		break;
	}
...
#undef HTTP_PORT
	...
	case 0:
		++ok;
		printf("GoFish expected reply\n");
		break;
	case 1:
		printf("Request failed %s", buf);
		break;
	case -1:
		break; // already printed error
	default:
	...
	default:
		++dubious;
		printf("Expected error result %d\n", rc);
		break;
	}
#endif
...
gateway:
	...
	case -1:
		break; // already printed error
	default:
		printf("Unexpected error return %d\n", rc);
		break;
	}
